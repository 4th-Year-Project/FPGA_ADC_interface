...
HD_PWD='C:/4th-year-project/FPGA_ADC_interface/FPGA_ADC_interface.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log FPGA_ADC_interface.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source FPGA_ADC_interface.tcl -notrace
