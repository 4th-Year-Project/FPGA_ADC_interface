...
HD_PWD='C:/4th-year-project/FPGA_ADC_interface/FPGA_ADC_interface.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log FPGA_ADC_interface.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source FPGA_ADC_interface.tcl
